...
# -----------------------------
# PII (post-traitement pragmatique)
# -----------------------------
...
def main():
    ...
    summary = {
        ...
        "audio_duration_s": asr.get("audio_duration_s"),
        "elapsed_s": asr.get("elapsed_s"),
        "rtf": asr.get("rtf"),
        "pii_stats": pii_stats,
        "intent_scores": intent_scores,
        "intent": intent,
        "top_terms": top_terms,
        # garde le transcript masqué, mais reste léger (éviter énorme dump si long)
